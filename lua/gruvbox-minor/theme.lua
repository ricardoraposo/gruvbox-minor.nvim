...
theme.set_highlights = function()
  ...
  hl(0, "Comment", { bg = "NONE", fg = p.Color1 })
  hl(0, "Constant", { bg = "NONE", fg = p.Color2 })
  hl(0, "Number", { bg = "NONE", fg = p.Color2 })
  hl(0, "String", { bg = "NONE", fg = p.Color3, italic = true })
  ...
  hl(0, "Pmenu", { bg = p.Color17, fg = p.Color10 })
  ...
  hl(0, "ColorColumn", { bg = p.Color16, fg = "" })
  hl(0, "Whitespace", { bg = "NONE", fg = p.Color17 })
  hl(0, "Todo", { bg = p.Color6, fg = p.Color11, bold = true, italic = false })
  ...
  hl(0, "DiagnosticUnderlineError", { bg = "NONE", fg = "NONE", undercurl = true, special = p.Color0 })
